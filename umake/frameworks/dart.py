...
class DartCategory(umake.frameworks.BaseCategory):
    def __init__(self):
        super().__init__(
            name="Dart",
            description=_("Dartlang Development Environment"),
            logo_path=None,
        )
...
class DartLangEditorRemoval(umake.frameworks.baseinstaller.BaseInstaller):
    def __init__(self, **kwargs):
        super().__init__(
            name="Dart Editor",
            description=_("Dart SDK with editor (not supported upstream anymore)"),
            download_page=None,
...
class DartLang(umake.frameworks.baseinstaller.BaseInstaller):
    def __init__(self, **kwargs):
        super().__init__(
            name="Dart SDK",
            description=_("Dart SDK (default)"),
        ...
        if in_download:
            with suppress(AttributeError):
                self.new_download_url = (
                    ...
                    + "dartsdk-linux-{}-release.zip".format(
