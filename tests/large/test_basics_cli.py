...
class BasicCLI(LargeFrameworkTests):
    ...
    def test_setup_info_logging(self):
        ...
        result = subprocess.check_output(
            self.command_as_list([UMAKE, "-v", "--help"]), stderr=subprocess.STDOUT
        )
    ...
    def test_setup_debug_logging(self):
        ...
        result = subprocess.check_output(
            self.command_as_list([UMAKE, "-vv", "--help"]), stderr=subprocess.STDOUT
        )
        self.assertIn(
            "DEBUG:", self.return_without_first_output(result.decode("utf-8"))
        )
    ...
    def test_setup_with_option_logging(self):
        ...
        try:
            subprocess.check_output(
                self.command_as_list([UMAKE, "-vouep", "--help"]),
                stderr=subprocess.STDOUT,
            )
        except subprocess.CalledProcessError as e:
            self.assertNotIn(
                "INFO:", self.return_without_first_output(e.output.decode("utf-8"))
            )
            self.assertNotIn(
                "DEBUG:", self.return_without_first_output(e.output.decode("utf-8"))
            )
    ...
    def test_setup_logging_level_with_env(self):
        ...
        result = subprocess.check_output(
            self.command_as_list(commands), env=env, stderr=subprocess.STDOUT
        )
    ...
    def test_framework_help(self):
        ...
        result = subprocess.check_output(
            self.command_as_list([UMAKE, "ide", "pycharm", "--help"])
        )
        self.assertNotEqual(result, "")
    ...
    def test_help_position_matters(self):
        ...
        result2 = subprocess.check_output(
            self.command_as_list([UMAKE, "ide", "--help", "pycharm"])
        )
        result3 = subprocess.check_output(
            self.command_as_list([UMAKE, "--help", "ide", "pycharm"])
        )
    ...
    def test_category_with_default_framework_help(self):
        ...
        result = subprocess.check_output(
            self.command_as_list([UMAKE, "android", "--help"])
        )
        self.assertNotEqual(result, "")
    ...
    def test_only_category_help_with_default_framework(self):
        ...
        result2 = subprocess.check_output(
            self.command_as_list([UMAKE, "android", "android-studio", "--help"])
        )
        self.assertNotEquals(result1, result2)
    ...
    def test_listing_installed_frameworks(self):
        ...
        result = subprocess.check_output(
            self.command_as_list([UMAKE, "--list-installed"])
        )
        self.assertNotEqual(result, "")
    ...
    def test_listing_available_frameworks(self):
        ...
        result = subprocess.check_output(
            self.command_as_list([UMAKE, "--list-available"])
        )
        self.assertNotEqual(result, "")
    ...
    def test_combine_listing_all_frameworks_and_available_frameworks(self):
        ...
        with self.assertRaises(subprocess.CalledProcessError):
            subprocess.check_output(
                self.command_as_list([UMAKE, "--list", "--list-available"]),
                stderr=subprocess.STDOUT,
            )
    ...
    def test_combine_listing_all_frameworks_and_installed_frameworks(self):
        ...
        with self.assertRaises(subprocess.CalledProcessError):
            subprocess.check_output(
                self.command_as_list([UMAKE, "--list", "--list-installed"]),
                stderr=subprocess.STDOUT,
            )
    ...
    def test_combine_listing_available_frameworks_and_installed_frameworks(self):
        ...
        with self.assertRaises(subprocess.CalledProcessError):
            subprocess.check_output(
                self.command_as_list([UMAKE, "--list-available", "--list-installed"]),
                stderr=subprocess.STDOUT,
            )
