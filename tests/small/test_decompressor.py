...
class TestDecompressor(LoggedTestCase):
    ...
    def test_decompress(self):
        ...
        Decompressor(
            {
                open(filepath, "rb"): Decompressor.DecompressOrder(
                    dest=self.tempdir, dir=""
                )
            },
            self.on_done,
        )
        ...
        self.assertTrue(
            os.path.isfile(os.path.join(self.tempdir, "server-content", "simplefile"))
        )
        self.assertTrue(
            os.path.isdir(os.path.join(self.tempdir, "server-content", "subdir"))
        )
        self.assertTrue(
            os.path.isfile(
                os.path.join(self.tempdir, "server-content", "subdir", "otherfile")
            )
        )
        self.assertEqual(
            self.on_done.call_count, 1, "Global done callback is only called once"
        )
    ...
    def test_decompress_move_dir_content(self):
        ...
        Decompressor(
            {
                open(filepath, "rb"): Decompressor.DecompressOrder(
                    dest=self.tempdir, dir="server-content"
                )
            },
            self.on_done,
        )
        ...
        self.assertTrue(
            os.path.isfile(os.path.join(self.tempdir, "subdir", "otherfile"))
        )
    ...
    def test_decompress_zip(self):
        ...
        self.assertTrue(
            os.path.isfile(
                os.path.join(self.tempdir, "server-content", "executablefile")
            )
        )
        self.assertTrue(
            os.path.isdir(os.path.join(self.tempdir, "server-content", "subdir"))
    ...
    def test_decompress_exec(self):
        ...
        self.assertTrue(
            os.path.isfile(os.path.join(self.tempdir, "android-ndk-foo", "ndk-which"))
        )
        self.assertTrue(
            os.path.isfile(os.path.join(self.tempdir, "android-ndk-foo", "ndk-build"))
        )
        ...
        with open(filepath, "rb") as fd:
            for line in fd:
                if line.startswith(b"== ARCHIVE TAG =="):
                    break
            Decompressor(
                {fd: Decompressor.DecompressOrder(dest=self.tempdir, dir="")},
                self.on_done,
            )
            self.wait_for_callback(self.on_done)
    ...
    def test_decompress_wrong_dir_content(self):
        ...
        Decompressor(
            {
                open(filepath, "rb"): Decompressor.DecompressOrder(
                    dest=self.tempdir, dir="doesnt-exists"
                )
            },
            self.on_done,
        )
    ...
    def test_decompress_multiple(self):
        ...
        Decompressor(
            {
                open(filepath1, "rb"): Decompressor.DecompressOrder(
                    dest=self.tempdir, dir=""
                ),
                open(filepath2, "rb"): Decompressor.DecompressOrder(
                    dest=self.tempdir, dir=""
                ),
            },
            self.on_done,
        ...
        self.assertTrue(
            os.path.isfile(os.path.join(self.tempdir, "server-content2", "simplefile2"))
        )
        self.assertTrue(
            os.path.isdir(os.path.join(self.tempdir, "server-content2", "subdir2"))
        )
        self.assertTrue(
            os.path.isfile(
                os.path.join(self.tempdir, "server-content2", "subdir2", "otherfile")
            )
        )
        self.assertEqual(
            self.on_done.call_count, 1, "Global done callback is only called once"
    ...
    def test_decompress_multiple_with_dir(self):
        ...
        Decompressor(
            {
                ...
                open(filepath2, "rb"): Decompressor.DecompressOrder(
                    dest=self.tempdir, dir="server-content2"
                ),
            },
            self.on_done,
        )
        ...
        self.assertTrue(
            os.path.isfile(os.path.join(self.tempdir, "subdir2", "otherfile"))
        )
        self.assertEqual(
            self.on_done.call_count, 1, "Global done callback is only called once"
        )
