...
class TestCLIFromFrameworks(LoggedTestCase):
    ...
    def setUpClass(cls):
        ...
        change_xdg_path(
            "XDG_CONFIG_HOME", os.path.join(get_data_dir(), "configs", "foo")
        )
        ...
        with patchelem(
            umake.frameworks,
            "__file__",
            os.path.join(cls.testframeworks_dir, "__init__.py"),
    ...
    def test_mangle_args_options_only(self):
        ...
        self.assertEqual(
            mangle_args_for_default_framework(["--foo", "-b"]), ["--foo", "-b"]
        )
    ...
    def test_mangle_args_default_framework(self):
        ...
        self.assertEqual(
            mangle_args_for_default_framework(["category-a"]),
            ["category-a", "framework-a"],
        )
    ...
    def test_mangle_args_without_framework_with_framework_options(self):
        ...
        self.assertEqual(
            mangle_args_for_default_framework(["category-a", "install_path", "--foo"]),
    ...
    def test_mangle_args_for_default_framework_with_simple_options(self):
        ...
        self.assertEqual(
            mangle_args_for_default_framework(["-v", "category-a", "--foo", "--bar"]),
    ...
    def test_mangle_args_for_framework_in_main_category_with_framework_extended_options(
        self,
    ):
    ...
    def test_mangle_args_for_framework_in_main_category_with_global_and_framework_extended_options(
        self,
    ):
    ...
    def test_mangle_args_for_framework_in_main_category_with_global_and_framework_extended_options_and_path(
        self,
    ):
    ...
    def test_mangle_args_for_category_without_default_framework(self):
        ...
        self.assertEqual(
            mangle_args_for_default_framework(["category-f"]), ["category-f"]
        )

    def test_mangle_args_for_category_without_default_framework_with_extended_options(
        self,
    ):
        """No framework in a category with ext. option without default are preserved"""
        self.assertEqual(
            mangle_args_for_default_framework(["category-f", "--foo", "install_path"]),
    ...
    def test_mangle_args_for_category_without_default_framework_with_install_path(self):
        ...
        self.assertEqual(
            mangle_args_for_default_framework(["category-f", "--foo", "install/path"]),
            ["category-f", "--foo", "install/path"],
        )

    def test_mangle_args_for_category_without_default_framework_with_global_and_extended_options(
        self,
    ):
    ...
    def test_mangle_args_for_category_with_short_remove_global_options(self):
        ...
        self.assertEqual(
            mangle_args_for_default_framework(["-r", "category-a", "framework-a"]),
