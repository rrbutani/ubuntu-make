...
class TestInteractions(LoggedTestCase):
    ...
    def test_choices(self):
        ...
        choices = [
            Choice(0, "Choice0", lambda: ""),
            Choice(1, "Choice1", lambda: ""),
    ...
    def test_choices_with_text_shorcut(self):
        ...
        choices = [
            Choice(0, "Choice0", lambda: "", txt_shorcut="A"),
            Choice(1, "Choice1", lambda: "", txt_shorcut="B"),
    ...
    def test_choices_with_default(self):
        ...
        choices = [
            Choice(0, "Choice0", lambda: ""),
            Choice(1, "Choice1", lambda: "", is_default=True),
            Choice(2, "Choice2", lambda: ""),
        ]
        inter = TextWithChoices("Foo Content", choices)
    ...
    def test_choices_prompt_with_txt_shortcut(self):
        ...
        self.assertEqual(
            inter.prompt, "Foo Content [Choice0 (A)/Choice1 (B)/Choice2 (c)] "
        )
    ...
    def test_instantiate_with_multiple_defaults_raises(self):
        ...
        choices = [
            Choice(0, "Choice0", lambda: "", is_default=True),
            Choice(1, "Choice1", lambda: "", is_default=True),
            Choice(2, "Choice2", lambda: ""),
        ]
    ...
    def test_choices_choose_run_right_callback(self):
        ...
        callback2 = Mock()
        choices = [
            Choice(0, "Choice0", Mock()),
            Choice(1, "Choice1", callback1),
    ...
    def test_choices_choose_with_shorcut_run_right_callback(self):
        ...
        callback2 = Mock()
        choices = [
            Choice(0, "Choice0", Mock(), txt_shorcut="A"),
            Choice(1, "Choice1", callback1, txt_shorcut="B"),
    ...
    def test_choices_wrong_txt_shortcut_raise(self):
        ...
        choices = [
            Choice(0, "Choice0", Mock(), txt_shorcut="A"),
            Choice(1, "Choice1", Mock(), txt_shorcut="B"),
    ...
    def test_choices_choose_default(self):
        ...
        choices = [
            Choice(0, "Choice0", Mock()),
            Choice(1, "Choice1", callback1, is_default=True),
            Choice(2, "Choice2", Mock()),
        ]
        inter = TextWithChoices("Foo Content", choices)
    ...
    def test_input_text_with_default_input(self):
        ...
        inter = InputText(
            "Content", lambda: "", default_input="This is a default input"
        )
